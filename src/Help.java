...
public class Help extends Scene {
  ...
  public void paintComponent(Graphics frame) {
    ...
    frame.drawString("Frog: Caterpillar, Ladybug, Grasshopper", 50, 140);
    frame.drawString("Shark: Pufferfish, Clownfish, Octopus", 50, 170);
    frame.drawString("Wolf: Pig, Sheep, Cow", 50, 200);
    frame.drawString("Tiger: Deer, Reindeer, Moose", 50, 230);
    frame.drawString("Snake: Mouse, Rat, Squirrel", 50, 260);
    frame.drawString("Lion: Horse, Donkey, Zebra", 50, 290);
    frame.drawString("T-Rex: Triceratops, Pterodactyl, Brachiosaurus", 50, 320);   
